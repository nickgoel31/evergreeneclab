        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-neutral-400 mb-6">
              Evergreen Enviro Consultancy and Laboratories has been at the forefront of environmental testing and consultancy since 2021. Our state-of-the-art facilities and expert team deliver accurate, reliable environmental solutions for businesses and communities.
            </p>
