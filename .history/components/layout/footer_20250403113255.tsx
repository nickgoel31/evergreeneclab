          ...
          <div>
            <Link href="/" className="flex items-center gap-2 mb-5">
              ...
              <span className="font-display font-semibold text-xl text-white">
                Evergreen <span className="text-primary">Enviro Testing</span>
              </span>
            </Link>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 group">
                ...
                <span className="text-neutral-300 group-hover:text-white transition-colors duration-300">
                  123 Environmental Way, Green City, 12345, Country
                </span>
              </li>
        ...
        <div className="border-t border-neutral-800 pt-8 mt-12">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-neutral-400 text-sm">
              © {new Date().getFullYear()} Evergreen Enviro Consultancy and Laboratories. All rights reserved.
            </p>
