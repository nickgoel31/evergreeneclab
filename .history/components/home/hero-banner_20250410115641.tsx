      ...
      <div className="container mx-auto px-4 py-24 md:py-32 relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <h5 className="text-primary-light font-display font-medium mb-4 bg-white/90 rounded-full px-4 py-1 inline-block hidden md:block">
          ...
          <p className="text-white/90 text-lg md:text-xl mb-8 max-w-2xl">
            Our lab provides comprehensive environmental testing, monitoring, and consultancy services to help businesses and communities thrive sustainably.
          </p>
