        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="rounded-xl overflow-hidden shadow-lg">
              <Image 
                src="https://images.unsplash.com/photo-1588076655076-0b48cdc121e0?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="bg-neutral-50 p-5 rounded-xl">
                  ...
                  <p className="text-neutral-600">
                    Our laboratories are equipped with advanced analytical instruments including AAS, GC and UV spectrophotometers.
                  </p>
                </div>
