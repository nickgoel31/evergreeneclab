...
const SoilAndSludgeTesting = () => {
  ...
  const service = servicesData.find(s => s.slug === "soil-and-sludge-testing");
  ...
  const soilAndSludgeTestingServices = [
    {
      title: "Contaminated Land Assessment",
      description: "Comprehensive screening for heavy metals, petroleum hydrocarbons, pesticides, and other contaminants to assess risks and remediation needs."
    },
    {
      title: "Agricultural Soil Analysis",
      description: "Detailed assessment of soil fertility parameters, nutrient levels, and physical properties to optimize crop production and sustainability."
    },
    {
      title: "Geotechnical Testing",
      description: "Analysis of soil physical properties, bearing capacity, compaction characteristics, and other parameters to support construction engineering."
    },
    {
      title: "Industrial Sludge Characterization",
      description: "Comprehensive testing of industrial sludges to determine appropriate handling, treatment, and disposal options in compliance with regulations."
    }
  ];
