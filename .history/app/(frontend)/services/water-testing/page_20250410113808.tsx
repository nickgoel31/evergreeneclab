            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="bg-neutral-50 p-5 rounded-xl">
                  ...
                  <p className="text-neutral-600">
                    Our laboratories are equipped with advanced analytical instruments including AAS, GC and UV spectrophotometers for comprehensive water quality assessment.
                  </p>
                </div>
