    ...
    <>
            ...
            {featuredClients.map((client:Client) => (
              ...
              >
                <Image 
                  ...
                  alt={client.name} 
                  className="max-h-12 max-w-[80%] w-fit hover:grayscale-0 transition-all duration-500"
                  width={100}
                  height={100}
                />
              </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl font-display font-bold mb-4">Our Client Network</h2>
            <p className="text-neutral-500">
            ...
            {regularClients.map((client: Client) => (
              ...
              >
                <Image 
                  src={urlFor(client.logo).url()} 
                  alt={client.name} 
                  className="max-h-10 w-fit max-w-[80%] hover:grayscale-0 transition-all duration-300"
                  width={300}
                  height={300}
                />
              </div>
          ...
          >
            <div className="inline-flex items-center gap-2 bg-neutral-100 px-6 py-3 rounded-full">
              ...
              <span className="font-medium">These are just few, we are working with 700+ clients across the country</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-neutral-600 max-w-2xl mx-auto mb-8">
              Contact our team today to discuss how Evergreen Enviro Testing LLP can support your environmental testing and consultancy needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/enquiry">
                ...
                >
                  <Button className="bg-primary hover:bg-primary/90 text-white rounded-full px-8 py-3 h-auto">
