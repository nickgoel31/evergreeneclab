            ...
            {featuredClients.map((client:Client) => (
              ...
              >
                <Image 
                  ...
                  alt={client.name} 
                  className="max-h-12 max-w-[80%] w-fit grayscale hover:grayscale-0 transition-all duration-500"
                  width={100}
                  height={100}
                />
              </div>
            ...
            {regularClients.map((client: Client) => (
              ...
              >
                <Image 
                  src={urlFor(client.logo).url()} 
                  alt={client.name} 
                  className="max-h-10 w-fit max-w-[80%] grayscale hover:grayscale-0 transition-all duration-300"
                  width={300}
                  height={300}
                />
              </div>
