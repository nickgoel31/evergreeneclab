        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-neutral-500">
              At Evergreen Enviro Testing LLP, we maintain the highest standards of quality and excellence. Our certifications and accreditations demonstrate our commitment to providing reliable, accurate, and compliant environmental services.
            </p>
          </div>
